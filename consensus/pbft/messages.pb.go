...
type Message_CurrentView struct {
	CurrentView *CurrentView `protobuf:"bytes,10,opt,name=current_view,json=current_view,oneof"`
}
...
func (*Message_CurrentView) isMessage_Payload()        {}
...
func (m *Message) GetCurrentView() *CurrentView {
	if x, ok := m.GetPayload().(*Message_CurrentView); ok {
...
func _Message_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Message_CurrentView:
		b.EncodeVarint(10<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.CurrentView); err != nil {
			return err
		}
	case nil:
	default:
...
func _Message_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 9: // payload.return_request_batch
		...
		return true, err
	case 10: // payload.current_view
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(CurrentView)
		err := b.DecodeMessage(msg)
		m.Payload = &Message_CurrentView{msg}
		return true, err
	default:
		return false, nil
	}
...
func (m *CurrentView) Reset()                    { *m = CurrentView{} }
func (m *CurrentView) String() string            { return proto.CompactTextString(m) }
func (*CurrentView) ProtoMessage()               {}
func (*CurrentView) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func init() {
	...
	proto.RegisterType((*CurrentView)(nil), "pbft.current_view")
